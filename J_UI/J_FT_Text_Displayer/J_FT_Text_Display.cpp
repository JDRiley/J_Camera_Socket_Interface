...
J_FT_Text_Display::J_FT_Text_Display(j_uint i_obj_id): J_Display_Box(i_obj_id){
	M_new_line_size = 30;
...
void J_FT_Text_Display::set_string(const J_UI_Multi_String& irk_string){
	...
	M_new_line_size = static_cast<int>(1.05*M_new_line_size);
...
void J_FT_Text_Display::delete_font_face(J_Font_Face i_font_face){delete i_font_face;}
