...
public:
	...
	virtual ~J_View();
	virtual void mouse_button_press(J_View_Shared_t, int button, int modifier, Pen_Pos_FL_t pos);
...
protected:
	...
	J_FT_Text_Display_Shared_t get_text_display(j_uint i_obj_id);
...
private:
	...
	std::map<j_uint, J_FT_Text_Display_Shared_t> M_text_displays;
